    ...
    render() {
        return (
            <Form handleSubmit={this.handleSubmit.bind(this)} errors={this.state.errors} top>
                ...
                <TextField label='Amount' name='amount' onChange={this.handleChange.bind(this)} defaultValue={String(this.state.donor.amount)} style={{ width: '100%' }} required /><br /><br />
                ...
                <TextField label='City' name='city' onChange={this.handleChange.bind(this)} defaultValue={this.state.donor.city} style={{ width: '100%' }} required /><br />
                <TextField label='State' name='state' onChange={this.handleChange.bind(this)} defaultValue={this.state.donor.state} style={{ width: '100%' }} required /><br />
                <TextField label='Zipcode' name='zipcode' onChange={this.handleChange.bind(this)} defaultValue={this.state.donor.zipcode} style={{ width: '100%' }} required /><br /><br /><br />
                ...
                <TextField label='Occupation' name='occupation' onChange={this.handleChange.bind(this)} defaultValue={this.state.donor.occupation} style={{ width: '100%' }} /><br />
                <TextField label='Employer' name='employer' onChange={this.handleChange.bind(this)} defaultValue={this.state.donor.employer} style={{ width: '100%' }} /><br /><br />
