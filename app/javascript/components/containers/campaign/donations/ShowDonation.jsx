...
import Donation from '../../../components/campaign/donations/Donation';
        ...
        return (
            <div className='content'>
                ...
                <div className='resource-actions'>
                    <Link className='resource-actions-item unstyled-link-black' to={`/campaign/donations/${this.props.match.params.id}/edit`}>
